...
public class StatusListParserData {
    public ArrayList<OfflineStatusStructure> parseOneFriendStatusListToArraylist(ArrayList<FriendsPostInformation> userList) {
